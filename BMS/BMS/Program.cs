...
namespace BMS
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("please cheose to log as Admin or Client:");
            User user = new User();
            ...
            while (input != 0) 
            {
                ...
                if (user.Role == "admin")
                {
                    ...
                    + "\nEnter 5 to creat new ticket."
                    + "\nEnter 6 to delate ticket."
                    ...
                    switch (input)
                    {
                        ...
                        case 5:
                            ...
                            break;
                        case 6: 
                            Console.WriteLine("please wnter Tickit Id to delete:");
                            var id = Convert.ToInt32(Console.ReadLine());
                            operation.DeleteTicket(id);
                            Console.WriteLine("Teckit has been deleted successfuly\n");
                            break;
                        case 7:
                            Console.WriteLine("please cheose to log as Admin or Client:");
                ...
                else if (user.Role == "client")
                {
                    ...
                    switch (input)
                    {
                        ...
                        case 3:
                            ...
                            userId = Convert.ToInt32(Console.ReadLine());
                            Console.WriteLine("Please enter Teckit Id:");
                        ...
                        case 4:
                            ...
                            if (selectedTicket[0].UserId== userId)
                            {
                                ...
                                Console.WriteLine("Ticket Book has been canceled\n");

                            }
                            else
                                Console.WriteLine("the ticket is not belong to you!!");
                ...
                {
                    Console.WriteLine("your choose is no correct \nPlease enter agian");
                    user.Role = Console.ReadLine().ToLower();
